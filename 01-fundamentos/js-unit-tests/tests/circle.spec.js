...
describe("4 - Implemente os casos de teste para a função `circle`", () => {
  ...
  it ("Verifica se a função `circle` retorna undefined caso o parametro não seja um numero", () => {
  ...
  it ("Verifica se a função `circle` retorna um objeto com 3 propriedades", () => {
    const actual = Object.keys(circle(2))
    expect(actual).toHaveLength(3);
  })
  // Teste se a função, quando não recebe nenhum parâmetro, retorna undefined.
  it ("Verifica se a função `circle` retorna undefined quando não é passado nenhum parametro", () => {
  ...
  it ("Verifica se a função `circle` retorna uma key com value igual a circunferência correta para um círculo de raio 2 ", () => {
    const actual = circle(2).circumference
  ...
  it ("Verifica se a função `circle` retorna uma key com value igual a área correta para um círculo de raio 3", () => {
    const actual = circle(3).area
    const expected = 28.26;

    expect(actual).toBeCloseTo(expected)
  })
  // Teste que a função retorna, num objeto, os dados corretos de um círculo de raio 3.
  it("Verifica se ao receber um raio de valor 3, a função `circle` retorna um objeto contedos os valores esperados", () => {
