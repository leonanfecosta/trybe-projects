...
describe("2 - Implemente os casos de teste para a função `numbers`", () => {
  ...
  it("Verifica se a função numbers retorna true dado o array [1, 2, 3, 4, 5] como parametro", () => {
    expect(numbers([1, 2, 3, 4, 5])).toBeTruthy();
  })
  // Escreva um teste em que a função recebe [1, 2, '3', 4, 5] e retorna false
  it("Verifica se a função numbers retorna false dado o array [1,2,'3',4,5] como parametro", () => {
    expect(numbers([1, 2, '3', 4, 5])).toBeFalsy();
  })
  // Escreva um teste em que a função recebe [1, 'a', 3] e retorna false
  it("Verifica se a função numbers retorna false dado o array [1, 'a', 3] como parametro", () => {
    expect(numbers([1, 'a', 3])).toBeFalsy();
  })
  // Escreva um teste em que a função recebe [' '] e retorna false
  it("Verifica se a função numbers retorna false dado um array vazio como parametro", () => {
